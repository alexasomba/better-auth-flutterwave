...
function Home() {
  ...
  useEffect(() => {
    ...
    const tools = [
      {
        name: "open_home",
        description: "Navigate to the Better Auth Flutterwave demo home page.",
        inputSchema: {
          type: "object",
          properties: {},
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-linear-to-b from-background to-muted/20 font-sans">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight">
            Better Auth + Flutterwave SDK = ♥
          </h1>
          <p className="text-muted-foreground">The ultimate Flutterwave plugin for Better Auth.</p>
        </div>
        ...
        <Card className="border-border/50 shadow-xl shadow-primary/5 backdrop-blur-sm bg-background/80">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>
              Experience seamless payments with one click, powered by better-auth-flutterwave.
            </CardDescription>
          </CardHeader>
      ...
      <footer className="absolute bottom-0 w-full text-center text-sm text-gray-500 py-4">
        <div className="space-y-3">
          <div>Powered by better-auth-flutterwave</div>
          <div className="flex items-center justify-center gap-4">
            <a
              href="https://github.com/alexasomba/better-auth-flutterwave"
              target="_blank"
