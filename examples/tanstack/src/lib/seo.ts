...
export const siteName = "Better Auth Flutterwave";
export const defaultSeoTitle = "Better Auth Flutterwave TanStack Start Demo";
export const defaultSeoDescription =
  "Demo billing workbench for Better Auth Flutterwave on TanStack Start, with Flutterwave subscriptions, one-time payments, organization billing, and secure webhooks.";

const fallbackOrigin = "http://localhost:3000";
const defaultImagePath = "/logo512.png";
const githubUrl = "https://github.com/alexasomba/better-auth-flutterwave";
const npmUrl = "https://www.npmjs.com/package/@alexasomba/better-auth-flutterwave";
